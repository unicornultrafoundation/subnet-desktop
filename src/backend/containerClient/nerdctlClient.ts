...
export class NerdctlClient implements ContainerEngineClient {
  ...
  async waitForReady(): Promise<void> {
    ...
    const commandsToCheck = [['/usr/local/bin/nerdctl', 'system', 'info']]
  ...
  readFile(
    imageID: string,
    filePath: string,
    options: { encoding?: BufferEncoding; namespace?: string }
  ): Promise<string>
  ...
  runClient(
    args: string[],
    stdio?: 'ignore',
    options?: ContainerRunClientOptions
